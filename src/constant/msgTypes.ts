...
export const WALLET_GET_CREATE_MNEMONIC_CHALLENGE = "WALLET_GET_CREATE_MNEMONIC_CHALLENGE";
export const WALLET_CONFIRM_CREATE_MNEMONIC = "WALLET_CONFIRM_CREATE_MNEMONIC";
export const WALLET_CLEAR_CREATE_MNEMONIC = "WALLET_CLEAR_CREATE_MNEMONIC";
export const WALLET_GET_CREATE_FLOW_STATE = "WALLET_GET_CREATE_FLOW_STATE";
...
export const DAPP_ACTION_CANCEL_APPROVE = "DAPP_ACTION_CANCEL_APPROVE";
