 ...
 * Check vault version
 */
const getVaultVersion = (data: VaultData): "v1" | "v2" | null => {
  if (!data) return null;
 ...
 */
const getAllAccountsFromVault = (data: VaultData): AccountInfo[] => {
  if (!data) return [];
 ...
 */
const getMnemonicFromVault = (data: VaultData): string | null => {
  if (!data) return null;
