...
export const StyledRowCommonContainer = styled.div`
  background: #f9fafc;
  border-radius: 12px;
...
export const StyledAccountType = styled.div`
  font-weight: 500;
  font-size: 12px;
  text-align: center;
  color: white;
...
export const StyledKeyringAccountRow = styled.div`
  background: #f9fafc;
  padding: 10px 20px 10px;
  display: flex;
  align-items: stretch;
...
export const StyledKeyringAccountName = styled.p`
  font-size: 16px;
  font-weight: 600;
...
export const StyledKeyringAddress = styled.p`
  font-size: 12px;
  color: ${({ $isSelect }) => $isSelect ? "rgba(255, 255, 255, 0.5)" : "rgba(128, 128, 128, 1)"};
  margin: 2px 0px 0px;
`;

export const StyledKeyringBalance = styled.p`
  font-size: 12px;
  font-weight: 600;
