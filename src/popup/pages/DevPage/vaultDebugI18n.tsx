...
export const t = (key: keyof typeof VAULT_DEBUG_I18N.en): string => {
  const locale = getVaultDebugLocale();
  const translations = VAULT_DEBUG_I18N[locale as keyof typeof VAULT_DEBUG_I18N];
  return translations?.[key] || VAULT_DEBUG_I18N.en[key] || key;
};
