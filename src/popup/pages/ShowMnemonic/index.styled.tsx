...
interface StyledMneIndexProps {
  $small?: boolean;
  $colorStatus?: boolean;
}

interface StyledMneItemProps {
  $small?: boolean;
}
...
export const StyledMneItemContainer = styled.div<StyledMneItemContainerProps>`
  background: #594af1;
  border-radius: 20px;
  display: flex;
  align-items: center;
...
export const StyledMneIndex = styled.p<StyledMneIndexProps>`
  font-size: ${({ theme }) => theme.typography.fontSizeContent};
  line-height: 100%;
  text-align: center;
...
export const StyledMneItem = styled.span<StyledMneItemProps>`
  font-weight: ${({ theme }) => theme.typography.fontWeightMedium};
  font-size: ${({ theme }) => theme.typography.fontSizeContent};
  line-height: 100%;
  text-align: center;
