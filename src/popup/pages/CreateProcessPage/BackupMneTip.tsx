...
import type { ProcessViewProps, VoidCallback } from "../../types/common";

interface RowCheckLineProps {
  content: string;
...
const RowCheckLine = ({ content, onClick, checkStatus }: RowCheckLineProps) => (
...
export const BackupMneTip = ({ onClickNext, onClickPre }: ProcessViewProps) => {
